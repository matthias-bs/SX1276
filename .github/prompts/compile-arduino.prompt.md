...
2. Deduces the sketch folder from the currently active file: walks upward until a
   `.ino` file is found; falls back to `examples/BresserRxExample` if none is found.  
...
- Warn the user: "arduino.json not found or missing fqbn — using default TTGO LoRa32 v2.1".
- Use fallback: `esp32:esp32:ttgo-lora32:Revision=TTGO_LoRa32_v21new`.
